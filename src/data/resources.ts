...
const pricingUrls: Record<string, string> = {
  ...
  "Payload": "https://payloadcms.com/get-started",
}
...
const resourceCatalog: Omit<Resource, "slug" | "pricingUrl" | "freeTier" | "accessRequirement">[] = [
  ...
  { name: "Payload", url: "https://payloadcms.com", faviconFile:"payload.com.webp", category: "cms", tags: ["headless", "next.js", "self-hosted"], description: { en: "An open-source Next.js backend and headless CMS you self-host, with an admin panel generated from your code.", es: "Backend Next.js y CMS headless open source que autoalojas, con panel de administración generado desde tu código." } },
