...
const pricingUrls: Record<string, string> = {
  ...
  "YYLO": "https://github.com/yylo-dev/yylo#readme",
...
const resourceCatalog: Omit<Resource, "slug" | "pricingUrl" | "freeTier" | "accessRequirement">[] = [
  ...
  { name: "YYLO", url: "https://yylo.dev", category: "ai", tags: ["cli", "coding agent", "open source"], description: { en: "Open-source command-line orchestrator for coding agents with a dedicated git worktree per task, typed validation and merge flows, and receipt-backed repository changes.", es: "Orquestador de código abierto por línea de comandos para agentes de programación, con un worktree de git dedicado por tarea, flujos tipados de validación y merge, y cambios en el repositorio respaldados por comprobantes." } },
