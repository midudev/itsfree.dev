...
export const freeTiers: Record<string, LocalizedFreeTier> = {
  ...
  "YYLO": { en: "Free and open source (MIT): the complete CLI with no account, no card and no paid tier of any kind; you bring your own model API keys.", es: "Gratis y de código abierto (MIT): el CLI completo, sin cuenta, sin tarjeta y sin ningún plan de pago; cada cual aporta sus propias claves de API." },
