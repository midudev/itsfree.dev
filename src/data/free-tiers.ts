...
export const accessRequirements: Partial<Record<string, AccessRequirement>> = {
  ...
  "Northflank": "card-for-full-limits",
...
export const freeTiers: Record<string, LocalizedFreeTier> = {
  ...
  "Northflank": { en: "Developer Sandbox: 2 services, 2 jobs and 1 addon for hobby projects. A payment method is required before creating resources.", es: "Developer Sandbox: 2 servicios, 2 jobs y 1 addon para proyectos hobby. Hay que añadir un método de pago antes de crear recursos." },
  ...
  "Azure DevOps": { en: "Free for 5 users: unlimited private Git repos, Azure Boards, 1,800 build mins/month (1 Microsoft-hosted job), 1 self-hosted job and 2 GiB Artifacts storage.", es: "Gratis para 5 usuarios: repos Git privados ilimitados, Azure Boards, 1.800 min/mes de build (1 job alojado por Microsoft), 1 job autohospedado y 2 GiB de Artifacts." },
  ...
  "IPQuery": { en: "Free public API with no sign-up or key: location, ISP and risk data; bulk lookups up to 10k IPs; rate limits for abuse prevention.", es: "API pública gratis sin registro ni clave: ubicación, ISP y riesgo; consultas en lote de hasta 10k IPs; límites antiabuso." },
  "DummyJSON": { en: "Completely free public fake REST API with no sign-up: products, users, carts, posts, auth, recipes and custom JSON responses.", es: "API REST falsa pública y gratis, sin registro: productos, usuarios, carritos, posts, auth, recetas y respuestas JSON personalizadas." },
